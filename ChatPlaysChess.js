...
var allowedToUseCommands = ['misterCHESSter','ChatPlaysChess_TV']; // Users allowed to use Commands (case sensitive)


var channelsToJoin = ['misterCHESSter']; // what channel you want the bot to join, you can put as many as you want in this list.


var OAuthToken = 'oauth:l2psz0v833w6v3kybw1s3jsbbuehyn'// Put your twitch token here, to get one visit: https://twitchapps.com/tmi/
